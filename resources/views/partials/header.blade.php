                ...
                <ul class="categories-filter animate-dropdown">
                  <li class="dropdown"> <a class="dropdown-toggle"  data-toggle="dropdown" href="category.html">Categories <b class="caret"></b></a>
                    <ul class="dropdown-menu" role="menu" >
                      ...
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- Fruit Trees</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- Indoor Plants</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- Outdoor Plants</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- Seeds</a></li>
                    </ul>
                  </li>
                </ul>
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown yamm mega-menu"> <a href="home.html" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Fruit Trees</a>
                ...
                <a href="category.html"  data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Indoor Plants <span class="menu-label hot-menu hidden-xs">hot</span> </a>
                  <ul class="dropdown-menu container">
                    <li>
                      <div class="yamm-content">
                        <div class="row">
                ...
                <li class="dropdown hidden-sm"> <a href="category.html">Fertilizers <span class="menu-label new-menu hidden-xs">new</span> </a> </li>
                <li class="dropdown hidden-sm"> <a href="category.html">Seeds</a> </li>
                <li class="dropdown"> <a href="contact.html">Gardening Tools</a> </li>
                <li class="dropdown"> <a href="contact.html">Outdoor Plants</a> </li>
                <li class="dropdown"> <a href="contact.html">Pots & Planters</a> </li>
