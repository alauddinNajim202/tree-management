                                    ...
                                    <div class="hot-deal-wrapper">
                                        <div class="image">
                                            <a href="#">
                                                ...
                                                <img src="{{ asset('assets/images/hot-deals/p13_hover.jpg') }}"
                                    ...
                                    <div class="hot-deal-wrapper">
                                        <div class="image">
                                            <a href="#">
                                                ...
                                                <img src="{{ asset('assets/images/hot-deals/p14_hover.jpg') }}"
                                                    alt="" class="hover-image">
                                            </a>
                                        </div>
                                    ...
                                    <div class="hot-deal-wrapper">
                                        <div class="image">
                                            <a href="#">
                                                ...
                                                <img src="{{ asset('assets/images/hot-deals/p15_hover.jpg') }}"
                                                    alt="" class="hover-image">
                                            </a>
                                        </div>
                                        <div class="sale-offer-tag"><span>35%<br>
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('assets/images/products/p9.jpg') }}"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('assets/images/products/p11.jpg') }}"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('assets/images/products/p15.jpg') }}"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('assets/images/products/p12.jpg') }}"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
                    ...
                    <div id="product-tabs-slider" class="scroll-tabs outer-top-vs">
                        <div class="more-info-tab clearfix ">
                            ...
                            <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                                ...
                                <li><a data-transition-type="backSlide" href="#smartphone" data-toggle="tab">Fruit
                                        Trees</a></li>
                                <li><a data-transition-type="backSlide" href="#laptop" data-toggle="tab">Indoor
                                        Plants</a></li>
                                <li><a data-transition-type="backSlide" href="#apple" data-toggle="tab">Outdoor
                                        Plants</a></li>
                            </ul>
                            <!-- /.nav-tabs -->
                        </div>
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html">
                                                                <img src="{{ asset('assets/images/products/p7.jpg') }}"
                                                                    alt="">
                                                                <img src="{{ asset('assets/images/products/p7_hover.jpg') }}"
                                                                    alt="" class="hover-image">
                                                            </a>
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html">
                                                                <img src="{{ asset('assets/images/products/p8.jpg') }}"
                                                                    alt="">
                                                                <img src="{{ asset('assets/images/products/p8_hover.jpg') }}"
                                                                    alt="" class="hover-image">
                                                            </a>
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html">
                                                                <img src="{{ asset('assets/images/products/p9.jpg') }}"
                                                                    alt="">
                                                                <img src="{{ asset('assets/images/products/p9_hover.jpg') }}"
                                                                    alt="" class="hover-image">
                                                            </a>
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html">
                                                                <img src="{{ asset('assets/images/products/p10.jpg') }}"
                                                                    alt="">
                                                                <img src="{{ asset('assets/images/products/p10_hover.jpg') }}"
                                                                    alt="" class="hover-image">
                                                            </a>
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html">
                                                                <img src="{{ asset('assets/images/products/p11.jpg') }}"
                                                                    alt="">
                                                                <img src="{{ asset('assets/images/products/p11_hover.jpg') }}"
                                                                    alt="" class="hover-image">
                                                            </a>
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html">
                                                                <img src="{{ asset('assets/images/products/p12.jpg') }}"
                                                                    alt="">
                                                                <img src="{{ asset('assets/images/products/p12_hover.jpg') }}"
                                                                    alt="" class="hover-image">
                                                            </a>
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html">
                                                                <img src="{{ asset('assets/images/products/p15.jpg') }}"
                                                                    alt="">
                                                                <img src="{{ asset('assets/images/products/p15_hover.jpg') }}"
                                                                    alt="" class="hover-image">
                                                            </a>
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html">
                                                                <img src="{{ asset('assets/images/products/p2.jpg') }}"
                                                                    alt="">
                                                                <img src="{{ asset('assets/images/products/p2_hover.jpg') }}"
                                                                    alt="" class="hover-image">
                                                            </a>
                                        ...
                                        <div class="item item-carousel">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="image">
                                                        <a href="detail.html">
                                                            <img src="{{ asset('assets/images/products/p14.jpg') }}"
                                                                alt="">
                                                            <img src="{{ asset('assets/images/products/p14_hover.jpg') }}"
                                                                alt="" class="hover-image">
                                                        </a>
                                        ...
                                        <div class="item item-carousel">
                                            <div class="products">
                                                <div class="product">
                                                    ...
                                                    <div class="product-info text-left">
                                                        <h3 class="name"><a href="detail.html">Neem Oil Iphone 5s
                                                                32GB</a></h3>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="description"></div>
                                                        <div class="product-price"> <span class="price"> $450.99
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html">
                                                                <img src="{{ asset('assets/images/products/p13.jpg') }}"
                                                                    alt="">
                                                                <img src="{{ asset('assets/images/products/p13_hover.jpg') }}"
                                                                    alt="" class="hover-image">
                                                            </a>
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html">
                                                                <img src="{{ asset('assets/images/products/p4.jpg') }}"
                                                                    alt="">
                                                                <img src="{{ asset('assets/images/products/p4_hover.jpg') }}"
                                                                    alt="" class="hover-image">
                                                            </a>
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html">
                                                                <img src="{{ asset('assets/images/products/p1.jpg') }}"
                                                                    alt="">
                                                                <img src="{{ asset('assets/images/products/p1_hover.jpg') }}"
                                                                    alt="" class="hover-image">
                                                            </a>
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html">
                                                                <img src="{{ asset('assets/images/products/p6.jpg') }}"
                                                                    alt="">
                                                                <img src="{{ asset('assets/images/products/p6_hover.jpg') }}"
                                                                    alt="" class="hover-image">
                                                            </a>
                                                    ...
                                                    <div class="product-info text-left">
                                                        <h3 class="name"><a href="detail.html">Orchid Mix Galaxy
                                                                S4</a></h3>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="description"></div>
                                                        <div class="product-price"> <span class="price"> $450.99
                                ...
                                <div class="products">
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image">
                                                <a href="detail.html">
                                                    <img src="{{ asset('assets/images/products/p3.jpg') }}"
                                                        alt="">
                                                    <img src="{{ asset('assets/images/products/p3_hover.jpg') }}"
                                                        alt="" class="hover-image">
                                                </a>
