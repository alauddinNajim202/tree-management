    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        ...
        <div id="owl-single-product">
            <div class="single-product-gallery-item" id="slide1">
                <a data-lightbox="image-1" data-title="Gallery" href=\"{{ asset('assets/images/products/p1.jpg') }}\">
                    <img class="img-responsive" alt="" src=\"{{ asset('assets/images/blank.gif') }}\" data-echo=\"{{ asset('assets/images/products/p1.jpg') }}\" />
                </a>
            </div><!-- /.single-product-gallery-item -->

            <div class="single-product-gallery-item" id="slide2">
                <a data-lightbox="image-1" data-title="Gallery" href=\"{{ asset('assets/images/products/p2.jpg') }}\">
                    <img class="img-responsive" alt="" src=\"{{ asset('assets/images/blank.gif') }}\" data-echo=\"{{ asset('assets/images/products/p2.jpg') }}\" />
                </a>
            </div><!-- /.single-product-gallery-item -->

            <div class="single-product-gallery-item" id="slide3">
                <a data-lightbox="image-1" data-title="Gallery" href=\"{{ asset('assets/images/products/p3.jpg') }}\">
                    <img class="img-responsive" alt="" src=\"{{ asset('assets/images/blank.gif') }}\" data-echo=\"{{ asset('assets/images/products/p3.jpg') }}\" />
                </a>
            </div><!-- /.single-product-gallery-item -->

            <div class="single-product-gallery-item" id="slide4">
                <a data-lightbox="image-1" data-title="Gallery" href=\"{{ asset('assets/images/products/p4.jpg') }}\">
                    <img class="img-responsive" alt="" src=\"{{ asset('assets/images/blank.gif') }}\" data-echo=\"{{ asset('assets/images/products/p4.jpg') }}\" />
                </a>
            </div><!-- /.single-product-gallery-item -->

            <div class="single-product-gallery-item" id="slide5">
                <a data-lightbox="image-1" data-title="Gallery" href=\"{{ asset('assets/images/products/p5.jpg') }}\">
                    <img class="img-responsive" alt="" src=\"{{ asset('assets/images/blank.gif') }}\" data-echo=\"{{ asset('assets/images/products/p5.jpg') }}\" />
                </a>
            </div><!-- /.single-product-gallery-item -->

            <div class="single-product-gallery-item" id="slide6">
                <a data-lightbox="image-1" data-title="Gallery" href=\"{{ asset('assets/images/products/p6.jpg') }}\">
                    <img class="img-responsive" alt="" src=\"{{ asset('assets/images/blank.gif') }}\" data-echo=\"{{ asset('assets/images/products/p6.jpg') }}\" />
                </a>
            </div><!-- /.single-product-gallery-item -->

            <div class="single-product-gallery-item" id="slide7">
                <a data-lightbox="image-1" data-title="Gallery" href=\"{{ asset('assets/images/products/p7.jpg') }}\">
                    <img class="img-responsive" alt="" src=\"{{ asset('assets/images/blank.gif') }}\" data-echo=\"{{ asset('assets/images/products/p7.jpg') }}\" />
                </a>
            </div><!-- /.single-product-gallery-item -->
...
<div class="col-lg-3">
         ...
         <div class="ad-imgs">
         <img class="img-responsive" src=\"{{ asset('assets/images/banners/home-banner1.jpg') }}\" alt="">
          <img class="img-responsive" src=\"{{ asset('assets/images/banners/home-banner2.jpg') }}\" alt="">
         </div>
          </div>
          <div class="col-lg-9">
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src=\"{{ asset('assets/images/products/p3.jpg') }}\" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src=\"{{ asset('assets/images/products/p4.jpg') }}\" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src=\"{{ asset('assets/images/blank.gif') }}\" data-echo=\"{{ asset('assets/images/products/p6.jpg') }}\" alt=""></a>
			</div><!-- /.image -->			
